...
class BetsControllerTest < ActionController::TestCase
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post :create, bet: { amount_betted: @bet.amount_betted, player_id: @bet.player_id, roulette_choice: @bet.roulette_choice, round_id: @bet.round_id }
    end
  ...
  test "should update bet" do
    patch :update, id: @bet, bet: { amount_betted: @bet.amount_betted, player_id: @bet.player_id, roulette_choice: @bet.roulette_choice, round_id: @bet.round_id }
    assert_redirected_to bet_path(assigns(:bet))
  end
